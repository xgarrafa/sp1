...
//!   [`prove_from_batched_inputs`](crate::stacked_pcs::basefold_prover_wrapper::prove_from_batched_inputs)
//!   in the prover wrapper.
//! - **Caller**: [`verifier.rs`](crate::stacked_pcs::verifier) constructs the `compute_batch_evals` closure
